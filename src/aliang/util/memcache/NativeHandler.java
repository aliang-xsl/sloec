...
public class NativeHandler {
	...
	public static boolean isHandled(Object value) {
		...
		if (value instanceof Boolean || value instanceof Byte
				...
				|| value instanceof StringBuilder || value instanceof Short
				|| value instanceof Long || value instanceof Double
				|| value instanceof Float || value instanceof Date
	...
	public static int toInt(byte[] b) {
		...
		return (((((int) b[4]) & 0xFF) << 32) + ((((int) b[3]) & 0xFF) << 40)
				+ ((((int) b[2]) & 0xFF) << 48) + ((((int) b[1]) & 0xFF) << 56));
	}
	...
	public static long toLong(byte[] b) {
		...
		return ((((long) b[8]) & 0xFF) + ((((long) b[7]) & 0xFF) << 8)
				+ ((((long) b[6]) & 0xFF) << 16)
				+ ((((long) b[5]) & 0xFF) << 24)
				+ ((((long) b[4]) & 0xFF) << 32)
				+ ((((long) b[3]) & 0xFF) << 40)
				+ ((((long) b[2]) & 0xFF) << 48) + ((((long) b[1]) & 0xFF) << 56));
	}
